//#region node_modules/.nitro/vite/services/ssr/assets/registrations-YjpLcfq4.js
var member = (name, email, phone, year = "III", department = "ECE") => ({
	name,
	email,
	phone,
	year,
...
var mockRegistrations = [
	...
	},
	{
		...
		teamName: "Nano Nodes",
		members: [member("Aravind K", "aravind.k@example.com", "+91 90000 10004", "IV"), member("Sneha P", "sneha.p@example.com", "+91 90000 10005", "IV")],
	...
	},
	{
		...
		members: [member("Divya M", "divya.m@example.com", "+91 90000 10015"), member("Karthik S", "karthik.s@example.com", "+91 90000 10016")],
...
//#endregion
export { registrationTrend as n, mockRegistrations as t };
