//#region node_modules/.nitro/vite/services/ssr/assets/events-C3idm_Mi.js
var categoryMeta = {
	technical: {
...
var commonFaq = [{
	...
	a: "Recommended but not mandatory. Lab systems are available on request."
}, {
	q: "Will certificates be issued?",
	a: "Yes. Every participant receives an e-certificate; winners receive merit certificates."
}];
var events = [
	{
		id: "e-techpaper",
		...
		description: "Present original technical work in electronics, communication, VLSI, embedded systems, signal processing, IoT or AI hardware. Abstracts are screened before the symposium and shortlisted teams present on stage.",
		teamSize: {
			min: 1,
			max: 3
		},
		...
		schedule: [
			{
				time: "09:00 AM",
				item: "Reporting and slide upload"
			},
			{
				time: "09:45 AM",
				item: "Session I presentations"
			},
			{
				time: "11:30 AM",
				item: "Session II presentations"
			},
			{
				time: "01:30 PM",
		...
		faq: [{
			...
			a: "Yes, provided it presents original analysis or comparison."
		}, ...commonFaq],
	...
	},
	{
		...
		description: "Bring a working prototype and demonstrate it live. Evaluation weighs innovation, technical depth, completeness of the build and real-world relevance.",
		teamSize: {
			min: 1,
			max: 4
		},
		...
		schedule: [
			{
				time: "09:15 AM",
				item: "Setup and table allocation"
			},
			{
				time: "10:00 AM",
				item: "Jury round I"
		...
		prizes: [
			...
			"Best innovation special mention"
		],
		faq: commonFaq,
	...
	},
	{
		...
		description: "Autonomous line following bots race a timed track with curves, junctions and gap sections. Fastest completion without manual intervention wins.",
		teamSize: {
			min: 1,
			max: 3
		},
		...
		faq: [{
			q: "Is the track surface glossy?",
			a: "Matte white vinyl with 3cm black tape; practice laps are provided."
		}, ...commonFaq],
	...
	},
	{
		...
		description: "A guided hands-on session covering the digital and analog VLSI flow in Cadence: schematic entry, simulation, layout, DRC/LVS checks and GDSII export.",
		teamSize: {
			min: 1,
			max: 1
		},
		...
		schedule: [
			{
				time: "09:30 AM",
				item: "VLSI flow overview"
			},
			{
				time: "10:30 AM",
				item: "Schematic entry and simulation"
			},
			{
				time: "01:30 PM",
				item: "Layout, DRC and LVS"
			},
			{
				time: "03:15 PM",
				item: "GDSII export and wrap-up"
			}
		],
		prizes: ["Participation certificate for all attendees"],
		faq: [{
			q: "Do I need prior Cadence experience?",
			a: "No. The session starts from tool basics."
		}, ...commonFaq],
	...
	},
	{
		...
		description: "Hands-on embedded development: microcontroller architecture, GPIO and peripheral drivers, sensor interfacing, interrupts and a guided mini project.",
		teamSize: {
			min: 1,
			max: 1
		},
		...
		schedule: [
			{
				time: "09:30 AM",
				item: "Architecture and toolchain setup"
			},
			{
				time: "11:00 AM",
	...
	},
	{
		...
		description: "Graphical programming with LabVIEW: dataflow fundamentals, front panel design, loops and structures, data acquisition and building a measurement application.",
		teamSize: {
			min: 1,
			max: 1
		},
		...
		schedule: [
			{
				time: "09:30 AM",
				item: "Dataflow and VI basics"
			},
			{
				time: "11:00 AM",
				item: "Front panel and block diagram design"
			},
			{
				time: "01:30 PM",
			...
			{
				time: "03:00 PM",
				item: "Measurement application build"
			}
		],
		prizes: ["Participation certificate for all attendees"],
		faq: commonFaq,
	...
	},
	{
		...
		description: "A rapid elimination contest of logical reasoning, circuits-inspired riddles and lateral thinking puzzles played in teams of two.",
		teamSize: {
			min: 1,
			max: 2
		},
		...
		schedule: [
			{
				time: "10:00 AM",
				item: "Round 1 - prelims"
			},
			{
				time: "11:15 AM",
				item: "Round 2 - elimination"
			},
			{
				time: "12:15 PM",
				item: "Round 3 - finals"
	...
	},
	{
		...
		description: "Participants are given creative and technical briefs and must craft prompts that produce the closest match to a target output. Judged on accuracy, creativity and efficiency.",
		teamSize: {
			min: 1,
			max: 2
		},
		...
		schedule: [{
			time: "11:00 AM",
			item: "Round 1 - creative brief"
		}, {
			time: "12:15 PM",
			item: "Round 2 - technical brief"
		}],
		prizes: ["Winner - cash prize", "Runner up - cash prize"],
		faq: commonFaq,
		coordinatorIds: ["c-anandha"],
	...
	},
	{
		...
		description: "Build memes on the spot from supplied templates and themes drawn from campus and engineering life. Scored on wit, originality and relevance.",
		teamSize: {
			min: 1,
			max: 2
		},
		...
		schedule: [{
			time: "01:30 PM",
			item: "Theme reveal and creation window"
		}, {
			time: "02:30 PM",
			item: "Screening and judging"
		}],
		prizes: ["Winner - cash prize", "Runner up - cash prize"],
		faq: commonFaq,
		coordinatorIds: ["c-sarvesan"],
	...
	},
	{
		...
		description: "A mystery trail mixing cryptic clues, buggy code snippets and hidden checkpoints across the department. First team to close the case wins.",
		teamSize: {
			min: 1,
			max: 3
		},
...
var getEventBySlug = (slug) => events.find((e) => e.slug === slug);
var eventsByCategory = (category) => events.filter((e) => e.category === category);
//#endregion
export { getEventBySlug as i, events as n, eventsByCategory as r, categoryMeta as t };
