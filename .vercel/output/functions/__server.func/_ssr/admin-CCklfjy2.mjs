...
import { n as AdminProvider, r as useAdmin, t as ADMIN_EMAIL } from "./AdminStore-leOcVMXS.mjs";
...
import { E as LayoutDashboard, L as CircleQuestionMark, M as CreditCard, P as Contact, S as LogOut, T as ListChecks, W as CalendarDays, a as Users, j as Download, l as ToggleLeft, p as Settings, u as SquareUser, v as PanelLeft } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-CCklfjy2.js
...
function AdminSidebar() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sidebar, {
		collapsible: "icon",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "truncate px-2 font-display text-sm font-bold tracking-wider text-metal-gradient",
			children: "EVITRON ADMIN"
		}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarContent, { children: [
			{
				label: "Overview",
				items: overview
			},
...
function AdminLayout() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminGate, {}) });
}
function AdminGate() {
	const { authed } = useAdmin();
	if (!authed) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminLogin, {});
...
function AdminLogin() {
	...
	const submit = (e) => {
		e.preventDefault();
		if (!login(email, password)) toast.error("Use the organiser email and a password of at least 4 characters.");
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Mock sign in for the organiser console."
					}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [
							"Mock auth only — any password of 4+ characters works with ",
							ADMIN_EMAIL,
							"."
						]
					}),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminSidebar, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				className: "grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-3 border-b border-border px-3 py-2",
				children: [
