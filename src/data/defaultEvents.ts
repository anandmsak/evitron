...
export const initialEvents: EventItem[] = [
  // --- WORKSHOPS (Individual, 1 Person = Rs 350) ---
  {
    ...
    venue: 'VLSI Design Lab, Department of ECE',
  ...
  },
  {
    ...
    certificates: 'Official Certificate of Workshop Completion from Mahendra Engineering College & IEEE.',
    importantInstructions: [
  ...
  },
  {
    ...
    venue: 'DSP & Virtual Instrumentation Lab, ECE Block',
    time: '09:30 AM - 04:00 PM',
    date: '08/10/2026',
  ...
  // --- TECHNICAL EVENTS (Team Size: Exactly 3 Participants) ---
  {
    ...
    venue: 'Seminar Hall 1, ECE Block',
    time: '10:00 AM - 01:00 PM',
    date: '08/10/2026',
    eligibility: 'UG / PG Engineering students. Teams must contain exactly 3 members.',
    teamSize: 3,
    teamSizeLabel: 'Team of Exactly 3 Participants',
    feePerPerson: 350,
    rules: [
      'Every team must have exactly 3 participants (1 Team Leader + 2 Team Members).',
      'Paper abstract must be submitted on or before 27/09/2026 via email to evitron26@gmail.com.',
      'Presentation time: 8 minutes for presentation + 2 minutes for Q&A by jury.',
      'Slides should not exceed 15 slides. Standard IEEE paper format preferred.',
      '[EVENT RULES WILL BE UPDATED]',
    ],
    procedure: [
    ...
    importantInstructions: [
      'Carry two printed copies of your full manuscript and softcopy in a pen drive.',
    ],
    faqs: [
      {
        q: 'Can members be from different colleges?',
        a: 'Yes, inter-college team members are allowed, but team size must be exactly 3 participants.',
      },
      {
  ...
  },
  {
    ...
    venue: 'Circuit & Systems Exhibition Hall',
    time: '10:00 AM - 01:30 PM',
    date: '08/10/2026',
    eligibility: 'Engineering UG/PG students. Exactly 3 members per team.',
    teamSize: 3,
    teamSizeLabel: 'Team of Exactly 3 Participants',
    feePerPerson: 350,
    rules: [
      'Every team must consist of exactly 3 members.',
      'Teams must bring their working prototype/hardware or software simulation demonstration.',
  ...
  },
  {
    ...
    venue: 'Indoor Robotics Arena, Mechanical/ECE Quadrangle',
    time: '11:00 AM - 02:00 PM',
    date: '08/10/2026',
    eligibility: 'Open to all Engineering students. Team size must be exactly 3 participants.',
    teamSize: 3,
    teamSizeLabel: 'Team of Exactly 3 Participants',
    feePerPerson: 350,
    rules: [
      'Team must have exactly 3 members.',
      'The robot must be completely autonomous; no manual remote controls allowed.',
      'Arena will have black lines (3cm width) on white background with 90-degree bends and speed sections.',
      'Max dimensions: 25cm x 25cm x 20cm; max weight: 3kg.',
      '[EVENT RULES WILL BE UPDATED]',
    ],
    procedure: [
      'Round 1: Calibration and qualifying time trial.',
      'Round 2: Knockout obstacle track with checkpoints.',
      'Fastest clean run with least penalties wins.',
    ],
    perks: [
    ...
    importantInstructions: [
      'Carry spare batteries and soldering kit if required for pit-lane repairs.',
    ],
    faqs: [
      {
  ...
  // --- NON-TECHNICAL EVENTS (Eligible only when at least 1 Technical event is selected) ---
  {
    ...
    slug: 'mind-maze',
    title: 'MIND MAZE',
    tagline: 'Aptitude, Riddles & Logic Quest',
    category: 'non-technical',
    description: 'Engaging brain-teaser showdown testing analytical speed, lateral thinking, cryptography, and logic puzzles under time pressure.',
    venue: 'Hall 204, Academic Block',
    time: '02:00 PM - 03:30 PM',
    date: '08/10/2026',
    eligibility: 'Must be registered for at least one Technical Event with your 3-member team.',
    teamSize: 3,
    teamSizeLabel: 'Same 3-Member Team',
    feePerPerson: 0, // Included with technical registration
    rules: [
      'Available only to participants who registered for a technical event.',
      'The 3-member team competes together.',
      'Use of mobile phones or internet search during the rounds is strictly prohibited.',
      '[EVENT RULES WILL BE UPDATED]',
    ],
    procedure: [
      'Round 1: Speed aptitude & visual pattern decoders (Buzzer round).',
      'Round 2: Cipher decoding and mystery puzzle solving.',
      'Round 3: Rapid-fire head-to-head finale.',
    ],
    perks: [
    ...
    outcomes: ['Sharpen rapid problem-solving and team collaboration skills.'],
  ...
  },
  {
    ...
    venue: 'Multimedia Computer Center',
    time: '02:00 PM - 03:30 PM',
    date: '08/10/2026',
    eligibility: 'Must be registered for at least one Technical Event with your 3-member team.',
    teamSize: 3,
    ...
    importantInstructions: ['Computers with internet access will be provided.'],
    faqs: [
      {
        q: 'Which AI platforms will be used?',
        a: 'Standard open/accessible generative interfaces will be provisioned on event day.',
      },
    ],
    coordinatorName: '[COORDINATOR NAME]',
    coordinatorPhone: '[COORDINATOR PHONE]',
  ...
  },
  {
    ...
    procedure: [
      ...
      '45 minutes design & crafting time.',
    ...
    importantInstructions: ['Bring laptops or smartphones with graphic editors.'],
    faqs: [
      {
  ...
  },
  {
    ...
    venue: 'Communications Lab, ECE Block',
    ...
    rules: [
      ...
      'Follow clues sequentially; do not damage lab equipment.',
      '[EVENT RULES WILL BE UPDATED]',
    ],
    procedure: [
    ...
    faqs: [
      {
        ...
        a: 'It combines both physical lab hunting and digital puzzle decoding!',
      },
    ],
    coordinatorName: '[COORDINATOR NAME]',
    coordinatorPhone: '[COORDINATOR PHONE]',
